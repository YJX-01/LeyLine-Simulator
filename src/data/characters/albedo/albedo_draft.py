...
def Albedo_NORMAL_ATK(character: 'Character', time: float):
    ...
    atk_event.initialize(character=character,
                         func=on_normal_atk,
                         desc='ALBEDO NORMAL ATK EVENT')
    ...
    damage_event.initialize(character=character,
                            func=on_damage,
                            desc='ALBEDO NORMAL ATK DAMAGE EVENT')
...
def Albedo_ELEM_SKILL(character: 'Character', time: float):
    ...
    elem_skill_event.initialize(character=character,
                                func=on_elem_skill,
                                desc='ALBEDO ELEM SKILL EVENT')
    ...
    damage_event.initialize(character=character,
                            func=on_damage,
                            desc='ALBEDO ELEM SKILL DAMAGE EVENT')
